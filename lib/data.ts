export const PRODUCTS = [
  {
    ...
    name: "Forged Round",
    shortDesc:
      "Precision solid round forgings for critical engineering applications",
    description:
    ...
    image: "/images/Forged-Round.png",
    specs: [
      { parameter: "Diameter Range", value: "50 mm – 600 mm" },
      { parameter: "Weight", value: "7.5 Ton Single PC" },
      { parameter: "Length", value: "8 M Long" },
      {
        parameter: "Surface Finish",
        value: "As-forged / Rough machined / Finish machined",
      },
      {
        parameter: "Dimensional Tolerance",
        value: "As per IS 1570 / DIN 17210",
      },
      {
        parameter: "Heat Treatment",
        value: "Normalized / Annealed / Quenched & Tempered",
      },
      {
        parameter: "Testing",
        value: "UT, MT, Hardness, Chemical analysis available",
      },
    ],
  },
  {
    ...
    image: "/images/product-hook-nut.png",
    specs: [
      { parameter: "Capacity", value: "75 Ton to 200 Ton" },
      { parameter: "Thread Type", value: "Square / ACME / Trapezoidal" },
      {
        parameter: "Material Grade",
        value: "EN8D, CL4, EN24 (as per IS 3832)",
      },
      {
        parameter: "Surface Finish",
        value: "Black finish / Rough machined / Finish machined",
      },
      {
        parameter: "Testing Standard",
        value: "IS 3832 / Customer specification",
      },
      {
        parameter: "Heat Treatment",
        value: "Normalized / Quenched & Tempered",
      },
      {
        parameter: "Load Test",
        value: "Proof load testing as per IS standard",
      },
    ],
  },
  {
    ...
    name: "Forged Shaft",
    shortDesc:
      "High-strength transmission shafts forged to exact specifications",
    description:
    ...
    specs: [
      ...
      {
        parameter: "Dimensional Tolerance",
        value: "h6 / h7 as per requirement",
      },
      {
        parameter: "Heat Treatment",
        value: "Normalized / Q&T / Case-hardened",
      },
      {
        parameter: "Testing",
        value: "UT, Hardness, Chemical composition on request",
      },
    ],
  },
  {
    ...
    image: "/images/Forged-Pinion.png",
    specs: [
      { parameter: "Size", value: "Up to 1400 mm" },
      { parameter: "Weight", value: "3 Ton Single PC" },
      ...
      {
        parameter: "Heat Treatment",
        value: "Normalized / Q&T / Induction hardened",
      },
    ],
  },
  {
    ...
    name: "Wheel Assembly",
    shortDesc:
      "Premium-grade forged wheel assemblies for heavy-duty material handling applications",
    description:
    ...
    image: "/images/product-wheel-assembly.png",
    specs: [
      {
        parameter: "Material",
        value: "Premium-grade forged steel and high-tensile alloys",
      },
      {
        parameter: "Manufacturing Process",
        value: "Precision machined and dynamically balanced",
      },
      {
        parameter: "Quality Testing",
        value:
          "Ultrasonic Testing (UT), Magnetic Particle Inspection (MPI), Dynamic Balancing",
      },
      {
        parameter: "Applications",
        value:
          "Crane long travels, transfer cars, overhead material handling systems",
      },
    ],
  },
  {
    ...
    name: "Forged Roll",
    shortDesc:
      "Premium-grade forged rolls for heavy-duty rolling and industrial processing applications",
    description:
      "Our forged rolls are manufactured from premium-grade alloy steel and forged under controlled conditions to achieve superior grain structure, exceptional strength, and long service life. Precision-machined on advanced CNC turning and grinding centers, each roll undergoes stringent quality inspections—including ultrasonic testing, hardness testing, dimensional verification, and surface finish inspection—to ensure consistent performance, excellent wear resistance, and high dimensional accuracy. Designed to withstand heavy rolling loads, thermal stress, and demanding industrial operating conditions.",
    applications: [
      "Rolling mill work rolls and backup rolls",
      "Heavy engineering and industrial processing equipment",
      "Custom forged rolls for specialized manufacturing processes",
    ],
    materials: ["Premium-Grade Alloy Steel"],
    image: "/images/product-forged-roll.png",
    specs: [
      { parameter: "Material", value: "Premium-grade alloy steel" },
      {
        parameter: "Manufacturing Process",
        value:
          "Controlled open-die forging with precision CNC turning and grinding",
      },
      {
        parameter: "Quality Testing",
        value:
          "Ultrasonic Testing (UT), Hardness Testing, Dimensional Verification, Surface Finish Inspection",
      },
      {
        parameter: "Applications",
        value:
          "Rolling mills, heavy engineering, industrial processing equipment, custom manufacturing processes",
      },
    ],
  },
];
...
export const MACHINES = [
  {
    ...
    image: "/images/machine/5-ton-hydraulic-hammer.jpg",
    capabilities: [
      "Max forging capacity: up to 7,500 kg per piece",
      "Ram weight: 5,000 kg",
      "Stroke energy: 50 kJ per blow",
      "Die area: 800 × 800 mm",
      "Suitable for large forgings: rounds, shafts, Rolls, Pinion",
    ],
    advantages: [
  ...
  },
  {
    ...
    image: "/images/machine/2-ton-pneaumatic-hammer.jpg",
    capabilities: [
      "Max forging capacity: up to 4,000 kg per piece",
      "Ram weight: 2,000 kg",
      "Stroke rate: up to 100 blows per minute",
      "Suitable for large forgings: rounds, shafts, Rolls",
  ...
  },
  {
    ...
    image: "/images/machine/5-ton-manipulator.jpg",
    capabilities: [
      "Grip load: 7,000 kg",
      "Billet length: up to 8000 mm",
  ...
  },
  {
    ...
    image: "/images/machine/3-ton-manipulator.jpg",
    capabilities: [
      "Grip load: 4000 kg",
      "Billet length: up to 8000 mm",
      "Full 360° billet rotation",
      "Positioning accuracy: ±2 mm",
      "Works seamlessly with 2T pneumatic hammer",
    ],
    advantages: [
  ...
  },
  {
    id: "2-vtl-machine",
    name: "2 VTL Machine",
    image: "/images/machine/2-vtl-machine.jpg",
    capabilities: [
      "Swing diameter: up to 1,400 mm",
  ...
  {
    id: "lathe-machine",
    name: "2 All Gear Lathe Machines",
    image: "/images/machine/machine-lathe-all-gear.jpg",
    capabilities: [
      "Swing over bed: 800 mm",
      "Distance between centres: up to 7,000 mm",
      "Max component weight: 2,000 kg",
      "We have 2 all gear lathe machine as well as 7 lathe machine total 9 machines",
  ...
  },
  {
    ...
    name: "15 Ton Hydra Machine",
    image: "/images/machine/machine-hydraulic-15t.jpg",
    capabilities: [
...
export const INDUSTRIES = [
  ...
  },
  {
    ...
    components: [
      "Crankshaft blanks",
      "Differential gear blanks",
      "Steering knuckle blanks",
      "Wheel hub blanks",
    ],
    image: "/images/industries-bg.jpg",
  },
...
export const CONTACT = {
  ...
  mapEmbedUrl:
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3683.116333272937!2d88.3386494!3d22.612130600000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f89d5f4d97cd6f%3A0xe901283f55bda264!2sVikash%20Forge%20Pvt.%20Ltd.!5e0!3m2!1sen!2sbd!4v1783584972005!5m2!1sen!2sbd",
};
